                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="max-w-4xl mx-auto text-center">
                        <h1 className="text-5xl md:text-6xl font-bold mb-6 text-white">
                            Privacy <span className="text-cny-gold">Policy</span>
                        </h1>
            ...
            <section className="py-16 bg-white dark:bg-gray-900">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="max-w-4xl mx-auto prose dark:prose-invert prose-lg">
                        ...
                        <p>
                            Email: <a href="mailto:privacy@remitone.com" className="text-cny-gold-accent hover:text-cny-gold-primary">privacy@remitone.com</a><br />
